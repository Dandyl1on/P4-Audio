...
def mainfunc():
    ...
    eq_settings = {
        (0, range1): low,  # Boost low frequencies (bass)
        (range1, range2): mid,  # Leave mid frequencies unchanged
        (range2, range3): upper,  # Reduce upper mids
        (range3, range4): high  # Slightly boost high frequencies (treble)
    }
